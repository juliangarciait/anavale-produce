...
class CustomerPortalAnavale(CustomerPortal):
    """ Inherited only to change pdf template to use:
        From: sale.action_report_saleorder
        To: anavale.action_report_saleorder_no_amounts """
    ...
    def portal_order_page(self, order_id, report_type=None, access_token=None, message=False, download=False, **kw):
        ...
        if report_type in ('html', 'pdf', 'text'):
            ...
            return self._show_report(model=order_sudo, report_type=report_type, report_ref='anavale.action_report_saleorder_no_amounts', download=download)
