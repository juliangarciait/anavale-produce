...
class LotData(models.Model):
    ...
    def create(self):
        ...
        for lot in res:
            ...
            vendor_prefix_len = [x.isdigit() for x in lot_name[vendor_prefix_idx:]].index(True) #encuentra los caracteres del vendor pueden ser 2 o 3
            tag_lot = lot_name[vendor_prefix_idx : (vendor_prefix_idx+ vendor_prefix_len+7)]  #se saca determina nombre para tag venxx-xxxx
